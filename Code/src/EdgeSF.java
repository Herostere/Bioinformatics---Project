...
public class EdgeSF {
    ...
    public int splitEdge(Suffix s) {
        remove();
        EdgeSF new_edge = new EdgeSF(first_char_index,
     ...
     * @return
     */
    public static EdgeSF find(int node, int c) {
        int i = hash(node, c);
        for (; ;) {
